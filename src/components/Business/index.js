    ...
    <div className="h-screen">
      <div>
        ...
        <div className="max-w-[60vw] mx-auto text-center font-montserrat my-16 ">
          <h1>
          Beaufort Capital has customized solutions to help your business grow. We provide flexible financing options for a variety of business needs. Our expert lending team will partner with you to understand your business and create a solution to take your business to the next level. 
          </h1>
        </div>
        ...
        <div className="lg:max-w-[60vw] max-w-[80vw] space-y-6 mx-auto text-center font-poppins my-10 ">
          ...
          <p>
            Beaufort Capital believes in creating amazing customer experiences with
        ...
        <div className="max-w-[80vw]  mx-auto my-20 gap-12 flex lg:flex-row flex-col justify-between ">
            ...
            <p className="font-montserrat">Learn about all of the exciting things going on at Beaufort Capital on our News page.</p>
