  ...
  const options = [
    {
      ...
      content: (
        <div className="space-y-6">
          <span>
            Conveniently transfer funds from your Beaufort Capital checking or savings
    ...
    },
    {
      ...
      content: (
        <div>
          Visit{" "}
          <span className="underline">Beaufort Capital branch locations.</span>{" "}
        </div>
      ),
    },
    {
      ...
      content: (
        <div>
          <span>
            Transfer funds at no cost to you from another Beaufort Capital account
    ...
    },
    {
      title: "by mail",
      content: (
        <a href='mailto:support@beaufort.com'>
          support@beaufort.com
        </a>
      ),
    },
  ];
        ...
        <div className="flex flex-col lg:flex-row  w-full h-full gap-20">
          <div className="flex-[1.8]">
            <h3 className="font-poppins mb-6">
              Beaufort Capital offers several convenient ways for you to pay down or
              make a payment on your Beaufort Capital loan(s). We appreciate you
              choosing Beaufort Capital and offer you easy and secure options to
              repay your loans.
            </h3>
            ...
            <div>
              ...
              <span className="text-center text-gray-500">
                Thank you for choosing Beaufort Capital
              </span>
            </div>
          </div>
